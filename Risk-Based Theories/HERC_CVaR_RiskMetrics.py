...
for ticker in tickers:
    ...
    cvar_results[ticker] = returns_data[returns_data[rt_col_name] < -last_var][rt_col_name].mean()
    cvar_results[ticker] = -cvar_results[ticker]
stock_cVaR = pd.Series(cvar_results)
stock_cVaR.index = 'rt_' + stock_cVaR.index
